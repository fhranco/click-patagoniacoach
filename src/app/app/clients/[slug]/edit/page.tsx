        ...
        {activeTab === 'brand' ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="card-premium p-10 space-y-8 bg-white border-gray-100 shadow-2xl shadow-black/[0.02]">
                 <div className="flex items-center gap-3 border-b border-gray-50 pb-6">
                   ...
                   <h3 className="font-black italic uppercase text-xs tracking-[0.2em]">Identidad Visual</h3>
                 </div>
                 ...
                 <div className="space-y-8">
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-4">
                        <input 
                          ...
                          className="w-14 h-14 rounded-2xl cursor-pointer border-4 border-white shadow-xl flex-shrink-0"
                        />
                        <input 
                          type="text" 
                          value={formData.brand_color} 
                    ...
                    <div className="space-y-3">
                      ...
                      <select 
                        ...
                        className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl font-bold text-xs outline-none focus:ring-2 focus:ring-patagonia-gold/20 appearance-none cursor-pointer"
                      >
                        <option value="neutral">Blanco Institucional</option>
                        <option value="stealth">Black Edition (Onyx)</option>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <button onClick={addLink} className="btn-secondary py-3 px-6 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
              ...
              {links.map((link) => (
                <div key={link.id} className="card-premium p-8 flex flex-col lg:flex-row items-center gap-8 group hover:border-patagonia-gold/30 transition-all bg-white shadow-xl shadow-black/[0.01]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1 w-full">
                     <InputField label="Texto del Botón" value={link.title} onChange={v => updateLink(link.id, { title: v })} />
                     <InputField label="URL de Destino" value={link.url} onChange={v => updateLink(link.id, { url: v })} />
                  </div>
                  ...
                  <div className="flex items-center gap-4 w-full lg:w-auto border-t lg:border-t-0 pt-6 lg:pt-0">
                     ...
                     >
                        <CheckCircle2 className="w-5 h-5" /> {link.active ? 'Público' : 'Oculto'}
                     </button>
                     <button 
